...
$screenshots = has_screenshots($system) ? '<a href="/Gallery.php?spgmGal=' . urlencode(strip_invalid_dos_chars($system)) . '" title="View image gallery"><img src="/style/img/image.png" alt="Gallery" class="icon" style="margin-left:5px;vertical-align:top" /></a>' : "";
...
if ($count > 0)
{
    ...
    else
    {
        ...
        if (!empty($visit))
        {
            ...
            echo '<a href="/System.php?system_name=' . urlencode($system) . '" style="color:inherit">';
        ...
        if ($logged > 0)
        {
            ...
            echo '<br />';
            echo '<a href="/log.php?system=' . urlencode($system) . '" style="color:inherit;font-weight:bold" title="View the log for this system">';
            echo $text . ' ...';
            echo '</a>';
        }
    }
