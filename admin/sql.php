...
if (isset($_POST["code"]))
{
	...
	if ($continue !== false)
	{
		if (!mysqli_query($GLOBALS["___mysqli_ston"], "" . $code . ""))
		{
...
<script type="text/javascript" src="/source/codemirror/addon/placeholder.js"></script>
<script type="text/javascript" src="/source/codemirror/mode/sql/sql.js"></script>
<?php echo $notify;?>
<div class="entries">
