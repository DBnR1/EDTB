...
function spgm_DisplayPicture($strGalleryId, $iPictureId, $strFilterFlags) {
  ...
  if ( spgm_IsPicture($strPictureFilename, $strGalleryId) ) {
    ...
    if ($spgm_cfg['conf']['filenameWithPictures'] == true) {
      ...
      print $strPictureBasename.''.$_strFileExtension.'&nbsp;<span id="uploaded" style="float:right;"><a href="javascript:void(0);" onclick="imgurUpload(\'' . $file . '\');"><img src="/style/img/upload.png" style="vertical-align:middle;opacity:1.0 !important;" />&nbsp;Upload to Imgur</a></span><br />'."\n";
      print ' </td>'."\n";
      print '</tr>'."\n";
    }
